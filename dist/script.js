...
const initFunc = async () => {
    const { projectName, isTypeScript, testingFramework } = await inquirer_1.default.prompt(questions_1.nameAndFrameWorkQs);
    ...
    return (0, index_1.projectGenerator)(projectName, zshPath, isTypeScript, testingFramework, isGithub, hasGitHubCLI, url, callBack);
};
